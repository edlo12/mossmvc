<?php
    ...
    */
    function autoload($aClassName) {
      $classFile = "/src/{$aClassName}/{$aClassName}.php";
       $file1 = MOSSMVC_SITE_PATH . $classFile;
       $file2 = MOSSMVC_INSTALL_PATH . $classFile;
       if(is_file($file1)) {
          require_once($file1);
    ...
    */
    function exception_handler($exception) {
      echo "Mossmvc: Uncaught exception: <p>" . $exception->getMessage() . "</p><pre>" . $e->getTraceAsString(), "</pre>";
    }
